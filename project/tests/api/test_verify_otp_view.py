...
class OtpViewSetTest(APITestCase):
    ...
    #
    # def Teardown(self):
    #     # how will i try down this user
    #     get_user_model().objects.all().delete()
    #     Artist.objects.all().delete()  # confrim this
...
def test_invalid_response_verify_otp_with_incorect_otp(self):
...
def test_valid_email_validotp(self):
    url = reverse('otps-verify')
    req_data = {
        "email": self.user["email"],
        "otp_code": self.user["otp_code"]
